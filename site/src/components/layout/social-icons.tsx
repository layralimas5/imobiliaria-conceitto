 ...
 *
 * Written by hand because lucide dropped brand marks in v1 — they are
 * trademarks, not interface icons. Both draw on `currentColor` and inherit
 * sizing from the class, so they behave like the lucide icons around them.
 */
